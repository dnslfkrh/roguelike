...
public class UpgradeManager : MonoBehaviour
{
    ...
    private void InitializeUpgrades()
    {
        ...
        {
            // Health Upgrades
            new CurrentHPUpgrade(),
            new MaxHPUpgrade(),
            
            // Combat Upgrades
            new PlayerDamageUpgrade(),
            new DoubleDamageHalfSpeedUpgrade(),
            
            // Movement Upgrades
            new PlayerSpeedUpgrade(),
            
            // Weapon Upgrades
            new AddSwordUpgrade(),
            new WeaponRotationSpeedUpgrade(),
            new WeaponDistanceUpgrade(0.5f, true),
            new WeaponDistanceUpgrade(-0.5f, false)
        };
    }
